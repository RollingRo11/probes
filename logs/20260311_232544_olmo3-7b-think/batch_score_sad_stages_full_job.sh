...
#SBATCH --gres=gpu:1
#SBATCH --time=6:00:00
#SBATCH --output=logs/20260311_232544_olmo3-7b-think/batch_score_sad_stages_full_slurm.log
#SBATCH --error=logs/20260311_232544_olmo3-7b-think/batch_score_sad_stages_full_slurm.log
